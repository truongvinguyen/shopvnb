...
<div class="col-md-12">
            <div class="right-content">
              <div class="container">
                <form id="contact" action="?act=them" method="POST">
                  <div class="row">
                    <div class="col-md-6">
                        <label for="">Tên sản phẩm</label>
                      <fieldset>
                        <input name="name_product" type="text" class="form-control"  placeholder="Tên sản phẩm" required="">
                      </fieldset>
                    </div>
                    <div class="col-md-6">
                    <label for="">Gía sản phẩm</label>
                      <fieldset>
                        <input name="price_product" type="text" class="form-control" placeholder="Gía sản phẩm" required="">
                      </fieldset>
                    </div>
                    <div class="col-md-6">
                    <label for="">ảnh sản phẩm</label>
                      <fieldset>
                        <input name="img_product" type="text" class="form-control"  placeholder="nhập tên hình ảnh" required="">
                      </fieldset>
                    </div>
                    <div class="col-md-6">
                    ...
                    <label for="">Loại sản phẩm</label>
                      <fieldset>
                        <input name="loai" type="text" class="form-control" >
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                        <label for="">Mô tả sản phẩm</label>
                      <fieldset>
                        <textarea name="detail" rows="6" class="form-control"placeholder="" required=""></textarea>
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                      <fieldset>
