<?php
            ...
            $product = new PRODUCT();
            $listProduct = $product->getAllcat();
            foreach($listProduct as $n){ ?>

       
                        <tr>
                           
                            <td class="cell-small text-center"><?php echo $n['id']; ?></td>
                            <td><a href="javascript:void(0)"><?php echo $n['name_category']; ?></a></td>
                            
                            <td class="text-center">
                                <div class="btn-group">
                                    
                                    <a href="?act=form_updatecat&id=<?php echo $n['id']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-success" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                    <a href="?act=deletecat&id=<?php echo $n['id']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php } ?>     
