                                ...
                                <div class="container">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="product-slider">
                                            ...
                                            <h3>Hình ảnh</h3>
                                            <img class="" src="../assets/img/images/<?php echo $n['image_product']; ?>.jpg" alt="" style="width: 450px; ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img class="news" src="../assets/img/images/<?php echo $n['trangthai']; ?>.gif" alt="" style="width: 70px;z-index: 1;">
                                        <hr>
                                        <h3>Tên sản phẩm</h3>
                                        <p><?php echo $n['name_product']; ?></p>
                                        <hr>
                                        <h3>Gía sản phẩm</h3>
                                        <p><?php echo $n['price_product']; ?>Đ</p>
                                        <hr>
                                        <h3>Mô tả sản phẩm</h3>
                                        <p><?php echo $n['detail_product']; ?> </p>
                                        <hr>
                                        <div><a class="btn btn-primary" href="?act=form_update&id=<?php echo $n['id']; ?>">Chỉnh sửa</a> <a class="btn btn-danger" href="?act=delete&id=<?php echo $n['id']; ?>">Xóa</a></div>
